...
describe('total likes', () => {
    ...
    test('when list has many blogs, amount sums up correctly', () => {
...
describe('most blogs', () => {
    test('when list has only one blog, returns the author and 1', () => {
...
describe('most likes', () => {
    test('when list has only one blog, returns the author and amount of likes', () => {
